    ...
    <>
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className={`text-2xl font-semibold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Wybierz usługę</h2>
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={`mt-1 ${isDarkMode ? "text-blue-100/90" : "text-gray-600"}`}>{service.description}</p>
                    <div className={`flex items-center mt-2 text-sm ${isDarkMode ? "text-blue-200" : "text-gray-500"}`}>
