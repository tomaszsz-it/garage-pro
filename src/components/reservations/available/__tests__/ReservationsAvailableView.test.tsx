...
vi.mock('../ServiceSelectionForm', () => ({
  default: ({ onServiceSelect }: { onServiceSelect: (service: ServiceDto) => void }) => (
    <div data-testid="service-selection-form">
      <button
        onClick={() => onServiceSelect(mockService)}
...
vi.mock('../CalendarView', () => ({
  default: ({ onTimeSelect, onBack }: { 
    onTimeSelect: (slot: AvailableReservationViewModel) => void;
    onBack: () => void;
  }) => (
    <div data-testid="calendar-view">
      <button
        onClick={() => onTimeSelect(mockAvailableSlot)}
...
vi.mock('../BookingConfirmationForm', () => ({
  default: ({ onVehicleSelect, onCreateReservation, onBack }: {
    ...
    <div data-testid="booking-confirmation-form">
      <button
        onClick={() => onVehicleSelect(mockVehicle)}
        data-testid="select-vehicle-btn"
      >
        Select Vehicle
      </button>
      <button
        onClick={() => onCreateReservation(mockReservationCreateDto)}
...
vi.mock('../ReservationConfirmationView', () => ({
  ReservationConfirmationView: ({ onBackToReservations }: {
